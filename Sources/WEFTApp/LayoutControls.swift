// LayoutControls.swift - Control strip for Layout visualization
            ...
            HStack(spacing: Spacing.xs) {
                ...
                Slider(
                    value: Binding(
                        ...
                        set: { state.resolution = max(2, min(LayoutState.maxResolution, Int($0))) }
                    ),
                    in: 2...Double(LayoutState.maxResolution),
                    step: 1
                )
                .frame(width: 60)
